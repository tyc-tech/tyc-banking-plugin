...
description: 贸易融资合规核查
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-trade-compliance · 贸易融资合规核查

本命令由 SKILL 文件定义，详见：[`../skills/trade-compliance/SKILL.md`](../skills/trade-compliance/SKILL.md)

## 快速使用

```
/tyc-trade-compliance <searchKey>
```
