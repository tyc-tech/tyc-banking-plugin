...
description: 信贷风险定期监控
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-credit-monitor · 信贷风险定期监控

本命令由 SKILL 文件定义，详见：[`../skills/credit-monitor/SKILL.md`](../skills/credit-monitor/SKILL.md)

## 快速使用

```
/tyc-credit-monitor <searchKey>
```
